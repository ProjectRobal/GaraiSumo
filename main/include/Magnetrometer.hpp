...
class Magnetrometer
{
    ...
    {   
        ...
        this->readings(0,0) = this->readXRaw();//this->x_kalman.step(this->readX());
        this->readings(1,0) = this->readYRaw();//this->y_kalman.step(this->readY());
        this->readings(2,0) = this->readZRaw();//this->z_kalman.step(this->readZ());
