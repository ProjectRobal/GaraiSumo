...
class Magnetrometer
{
    ...
    {   
        ...
        this->readings(0,0) = this->readX();//this->x_kalman.step(this->readX());
        this->readings(1,0) = this->readY();//this->y_kalman.step(this->readY());
        this->readings(2,0) = this->readZ();//this->z_kalman.step(this->readZ());
